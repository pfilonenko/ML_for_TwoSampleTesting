			...
			for(int i = 0; i<H.size(); i++)
			{
				...
				for(int per = 0; per<51; per+=10)
				{
					...
					for(int jj=0; jj<sample_sizes.size(); jj++)
					{
						...
						//Sn and p-value computation under Н0
						...
						//Sn and p-value computation under Н1
